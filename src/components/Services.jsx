function Services() {
  return (
    <>
      <section id="services" className="text-center mt-24">
        <div className="container">
          <div className="service">
            <h2 className="mb-5 text-6xl font-bold">services</h2>
          ...
          <div className="cards cards flex flex-wrap justify-center items-center gap-5">
